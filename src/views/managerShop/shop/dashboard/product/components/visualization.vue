    ...
    <el-card class="box-card">
      <div class="flex justify-between mb46">
        ...
        <div class="acea-row">
          ...
          <el-button type="primary" size="small" class="mr10" @click="onSeach"
            >查询</el-button
          >
          <el-button type="default" size="small" icon="el-icon-upload2" @click="exports"
            > 导出</el-button
          >
        </div>
      </div>
...
import { productDataApi, productTrendApi } from "@/api/dashboard";
export default {
  components: {
    echartsNew,
  },
