                ...
                <div class="acea-row">
                  <div class="user-visitUser">
                    <div class="data_num acea-row">
                      <div class="inone">
                        <div class="user_reg_tit">
                          注册用户数量:{{ userView.registerNum }}
                        </div>
                        <div class="reg_time">
                          环比增长率：{{ userView.registerNumRatio }}
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="orderUser">
                  <div class="user-orderUser acea-row">
                    <div class="data_num acea-row">
                      <div class="inone">
                        <div class="user_reg_tit">
                          活跃用户数量:{{ userView.activeUserNum }}
                        </div>
                        <div class="reg_time">
                          环比增长率：{{ userView.activeUserNumRatio }}
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="acea-row payOrderUser">
                  <div class="user-payOrderUser acea-row">
                    <div class="data_num acea-row">
                      <div class="inone">
                        <div class="user_reg_tit">
                          充值用户数量:{{ userView.rechargeUserNum }}
                        </div>
                        <div class="reg_time">
                          环比增长率：{{ userView.rechargeUserNumRatio }}
                        </div>
                      </div>
                      <div class="inone">
                        <div class="user_reg_tit">
                          客单价:{{ userView.customerPrice }}
                        </div>
                      </div>
                    </div>
                  </div>
