...
// crud交由presenter持有
const defaultCrud = CRUD({ title: 'ProductRelation', url: 'mall-debug/yxStoreProductRelation', type:'foot',sort: 'create_time,desc', crudMethod: { ...crudYxStoreProductRelation }})
...
export default {
  ...
  methods: {
    beforeInit() {
      this.url = 'mall-debug/yxStoreProductRelation'
