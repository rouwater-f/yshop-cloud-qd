      ...
      <el-table-column label="操作" width="160px" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button size="mini" style="margin-right: 2px" type="text">
            <router-link :to="'/sys/sys-tools/generator/preview/' + scope.row.tableName">
              预览
            </router-link>
          </el-button>
          ...
          <el-button size="mini" style="margin-left: -1px;margin-right: 2px" type="text">
            <router-link :to="'/sys/sys-tools/generator/config/' + scope.row.tableName">
              配置
            </router-link>
          </el-button>
...
// crud交由presenter持有
const defaultCrud = CRUD({ url: 'gen/generator/tables' })
export default {
  name: 'GeneratorIndex',
